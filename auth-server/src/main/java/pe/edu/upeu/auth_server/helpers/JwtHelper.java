package pe.edu.upeu.auth_server.helpers;
...
public class JwtHelper {
    ...
    //verifican si la fecha ya expiro
    private Date getExpirationDate(String token){
        return this.getClaimsFromToken(token, Claims::getExpiration);
    }
    private <T> T getClaimsFromToken(String token, Function<Claims,T> resolve){
        return resolve.apply(this.singToken(token));
    }
    //firmar el token
